...
arcpy.AddMessage((("Extent: XMin: {0}, XMax: {1}, YMin: {2}, YMax: {3}".format(extent.XMin, extent.XMax, extent.YMin, extent.YMax))))  # Accessing values associated with extent key
